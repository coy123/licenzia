...
const TableRow: React.FC<TableRowProps> = ({ data }) => {
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      key: 'location',
      className: 'flex-1 min-w-0 p-1 sm:p-2'
    ...
    React.createElement('div', {
      key: 'amount',
      className: 'w-16 sm:w-24 p-1 sm:p-2 flex-shrink-0'
    }, React.createElement('p', {
    ...
    React.createElement('div', {
      key: 'deadline',
      className: 'w-20 sm:w-28 p-1 sm:p-2 flex-shrink-0'
    }, React.createElement('p', {
    ...
    React.createElement('div', {
      key: 'button',
      className: 'w-16 sm:w-20 p-1 sm:p-2 flex-shrink-0'
...
const Table: React.FC<TableProps> = ({ data }) => {
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        key: 'header-amount',
        className: 'w-16 sm:w-24 p-1 sm:p-2 flex-shrink-0 text-right'
      }, React.createElement('span', {
        className: 'text-xs sm:text-sm text-gray-200'
      ...
      React.createElement('div', {
        key: 'header-deadline',
        className: 'w-20 sm:w-28 p-1 sm:p-2 flex-shrink-0 text-right'
      }, React.createElement('span', {
        className: 'text-xs sm:text-sm text-gray-200'
      ...
      React.createElement('div', {
        key: 'header-action',
        className: 'w-16 sm:w-20 p-1 sm:p-2 flex-shrink-0 text-center'
      }, React.createElement('span', {
        className: 'text-xs sm:text-sm text-gray-200'
